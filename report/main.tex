...
\addcontentsline{toc}{chapter}{DANH MỤC TÀI LIỆU THAM KHẢO TIẾNG ANH}
\printbibliography[heading=bibliography, title={DANH MỤC TÀI LIỆU THAM KHẢO TIẾNG ANH}, notkeyword=Viet, resetnumbers=true]

\clearpage
\phantomsection
\addcontentsline{toc}{chapter}{DANH MỤC TÀI LIỆU THAM KHẢO TIẾNG VIỆT}
\printbibliography[heading=bibliography, title={DANH MỤC TÀI LIỆU THAM KHẢO TIẾNG VIỆT}, keyword=Viet, resetnumbers=true]
\end{document} 
