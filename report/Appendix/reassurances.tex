...
\hfill % Đẩy toàn bộ khối bảng dưới đây sang góc bên phải trang giấy
\begin{tabular}{c} % 'c' giúp căn giữa chữ nội bộ bên trong khung ký tên này
    \textit{Thành phố Hồ Chí Minh, ngày  tháng  năm 2026} \\
    \textbf{Tác giả} \\
    \vspace{2.5cm} \\ % Khoảng trống dài để bạn ký tên bằng tay hoặc chèn chữ ký số
    \textbf{\nameStudent}
\end{tabular}
