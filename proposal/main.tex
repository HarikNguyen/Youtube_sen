...
\begin{document}
    ...
    Cũng như đề cập ở trên, nền tảng YouTube đối với đối với dữ liệu công khai rất đa dạng, với nhiều kênh cho nhiều lĩnh vực khác nhau, dẫn tới kho dữ liệu này có thể xem là một kho dữ liệu đa miền (multi-domain). Với bài toán này, đối với các ngôn ngữ phổ biến khác, đã và đang giải quyết, tuy nhiên đối với tiếng Việt thì hầu như đa số chỉ tập trung vào phần ngách ở một miền cụ thể.

    Ngoài ra, tuy tiếng Việt nằm trong top 20 ngôn ngữ có cộng đồng sử dụng nhiều nhất, nhưng nó đồng thời cũng gặp phải rào cản vùng miền địa lý, khi có nhiều từ địa phương khác nhau. Đồng thời, với sự hội nhập sâu rộng của văn hóa ngoại quốc mà vốn từ điển vốn có của người Việt hiện đại ngày càng mở rộng, phá vỡ đi các lối mòn truyền thống, như việc trộn mã (code-switching) dví dụ như "sản phẩm này nhìn rất chill", đang rất phổ biến tại Việt Nam. Và điều này diễn ra một cách bùng nổ theo thời gian. Cũng có nghĩa là, với một video cụ thể, theo thời gian ta có thể thu được nhiều cách diễn đạt thay đổi với vốn từ thay đổi cho cùng một loại cảm xúc. Điều đó đặt ra cho mô hình cần phải mang tính thích nghi cao với sự biến động này.

    Đồng thời, khi xét đến phương diện tiếng Việt hiện đại, đều dùng chữ Quốc ngữ, thuần âm để biểu đạt, thì vẫn có sự nhập nhằng trong cách sử dụng khi mà từ Hán - Việt chiếm tới xấp xỉ 70\% vốn từ. 
