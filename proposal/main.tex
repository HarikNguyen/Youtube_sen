...
\begin{document}
    ...
    Thời gian thực hiện đề tài nghiên cứu 0x tháng kể từ tháng xx/2026 đến xx/2026. Kế hoạch thực hiện chi tiết cho đề tài nghiên cứu được liệt kê như trong bảng \ref{tab:kehoach}.
    ...
    \begin{table}[htbp]
        ...
        Tìm hiểu các hướng tiếp cận và công trình liên quan &  \\ \hline
        Khảo sát, đánh giá các công trình tiêu biểu và hoàn thiện đề cương &  \\ \hline
        Nghiên cứu các phương pháp giải quyết bài toán &  \\ \hline
        Thu thập dữ liệu &  \\ \hline
        Huấn luyện mô hình &  \\ \hline
        Hoàn thiện quyển luận văn, chỉnh sửa theo góp ý của GVHD và chuẩn bị bảo vệ &  \\ \hline
        \end{tabularx}
