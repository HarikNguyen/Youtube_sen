...
def get_vn_categories(youtube_client):
    ...
    try:
        request = youtube_client.videoCategories().list(part="snippet", regionCode="VN")
...
def get_seed_channels_by_category(
    youtube_client, category_id, category_title, max_pages=10
):
